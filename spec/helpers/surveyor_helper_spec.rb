...
describe SurveyorHelper do
  ...
  it "should find or create responses, with index" do
    ...
    helper.response_for(rs, q2).attributes.reject{|k,v| k == "api_id"}.should == Surveyor::Response.new(:question => q2, :response_set => rs).attributes.reject{|k,v| k == "api_id"}
    helper.response_for(rs, q2, b).attributes.reject{|k,v| k == "api_id"}.should == Surveyor::Response.new(:question => q2, :response_set => rs).attributes.reject{|k,v| k == "api_id"}
