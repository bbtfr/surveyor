...
describe Surveyor::Response, "when saving a response" do
  before(:each) do
    # @response = Surveyor::Response.new(:question_id => 314, :response_set_id => 159, :answer_id => 1)
  ...
  it "should be in order by created_at" do
    ...
    Surveyor::Response.all.should == [@response, response2]
  end
...
describe Surveyor::Response, "applicable_attributes" do
  ...
  it "should not have string_value if response_type is answer" do
    ...
    Surveyor::Response.applicable_attributes(bad).
...
describe Surveyor::Response, '#json_value' do
  context "when integer" do
    let(:r) {Surveyor::Response.new(:integer_value => 2, :answer => Surveyor::Answer.new(:response_class => 'integer'))}
    it "should be 2" do
  ...
  context "when float" do
    let(:r) {Surveyor::Response.new(:float_value => 3.14, :answer => Surveyor::Answer.new(:response_class => 'float'))}
  ...
  context "when string" do
    let(:r) {Surveyor::Response.new(:string_value => 'bar', :answer => Surveyor::Answer.new(:response_class => 'string'))}
    it "should be 'bar'" do
  ...
  context "when datetime" do
    let(:r) {Surveyor::Response.new(:datetime_value => DateTime.strptime('2010-04-08T10:30+00:00', '%Y-%m-%dT%H:%M%z'), :answer => Surveyor::Answer.new(:response_class => 'datetime'))}
  ...
  context "when date" do
    let(:r) {Surveyor::Response.new(:datetime_value => DateTime.strptime('2010-04-08', '%Y-%m-%d'), :answer => Surveyor::Answer.new(:response_class => 'date'))}
  ...
  context "when time" do
    let(:r) {Surveyor::Response.new(:datetime_value => DateTime.strptime('10:30', '%H:%M'), :answer => Surveyor::Answer.new(:response_class => 'time'))}
